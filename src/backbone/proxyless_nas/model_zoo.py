...
def proxyless_base(pretrained=True, net_config="http://hanlab.mit.edu/files/proxylessNAS/proxyless_cpu.config", 
    ...
    return net
def proxyless_cpu_(pretrained=True, net_config_path=None, net_weight=None):
...
# summary(proxyless_gpu, (3, 224, 224))
