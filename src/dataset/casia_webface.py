...
class CASIAWebFace(data.Dataset):
    def __init__(self, root= '/mnt/01D4A1D481139570/Dataset/Face/CASIA/CASIA/CASIA-WebFace-112X96', file_list = '/mnt/01D4A1D481139570/Dataset/Face/CASIA/CASIA/CASIA-WebFace-112X96.txt', transform=None, loader=img_loader):
