...
import time
class MTCNN():
    def __init__(self, device = devi, thresholds = [0.3, 0.6, 0.8], nms_thresholds=[0.6, 0.6, 0.6]):
    ...
    def align_multi(self, img, limit=None, min_face_size=32.0, ):
    ...
    def detect_faces(self, image, min_face_size=32.0):
        """
        Arguments:
